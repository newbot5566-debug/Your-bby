...
┕━━━━━━━━━━━━━━━━━━━━━◊`
    ...
    if (cmd) {
      ...
      const helpMessage = `┍━━━[ 📚 ARIFUL☆ 𝗕𝗢𝗧 𝗛𝗘𝗟𝗣 ]━━━◊
...
┕━━━━━━━━━━━━━━━━━━━━━━◊`;
    ...
    try {
      await message.reply({
        body: msg,
        attachment: await global.utils.getStreamFromURL("https://files.catbox.moe/c12t8b.jpg")
      });
    } catch (error) {
      console.log("GIF attachment failed, sending text only:", error);
